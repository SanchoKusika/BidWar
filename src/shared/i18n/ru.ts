...
export const ru: PartialStrings = {
  ...
  settings: {
    ...
    removeProjects: 'Удалить мои проекты',
    removeProjectsNote: 'Удалит проекты и историю платежей — аккаунт станет как новый',
    removeTitle: 'Удалить мои проекты?',
    removeBody:
      'Проекты, ставки и вся история платежей будут удалены безвозвратно, баланс голосов обнулится. Оплаченное не возвращается.',
